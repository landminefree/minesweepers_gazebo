...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=polvoranca&box=-3.747887,40.359758,-3.842199,40.287893
...
-----------
  ...
  * polvoranca Height Map (ASTER 30m).png
  ...
  * polvoranca Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * polvoranca Height Map (SRTM3 v4.1).png
  ...
  * polvoranca Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 611m (actual) is equal to 40m in
